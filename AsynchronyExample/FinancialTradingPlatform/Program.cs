...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        Task<decimal[]> calculateUpperBoundBollingerBandTask = Task.Run(() => stockMarketTechnicalAnalysisData.CalculateUpperBoundBollingerBand());
        Task<decimal[]> calculateLowerBoundBollingerBandTask = Task.Run(() => stockMarketTechnicalAnalysisData.CalculateLowerBoundBollingerBand());
        ...
        tasks.Add(calculateUpperBoundBollingerBandTask);
        tasks.Add(calculateLowerBoundBollingerBandTask);
...
internal class StockMarketTechnicalAnalysisData
{
    ...
    public decimal[] GetOpeningPrices()
    {
        ...
        Console.WriteLine($"Method name: {nameof(GetOpeningPrices)}, Thread: {Thread.CurrentThread.ManagedThreadId}");

        Thread.Sleep(1000); // Represents the time it takes for the operations to complete
    ...
    public decimal[] GetClosingPrices()
    {
        ...
        Console.WriteLine($"Method name: {nameof(GetClosingPrices)}, Thread: {Thread.CurrentThread.ManagedThreadId}");
    ...
    public decimal[] GetPriceHighs()
    {
        ...
        Console.WriteLine($"Method name: {nameof(GetPriceHighs)}, Thread: {Thread.CurrentThread.ManagedThreadId}");
    ...
    public decimal[] GetPriceLows()
    {
        ...
        Console.WriteLine($"Method name: {nameof(GetPriceLows)}, Thread: {Thread.CurrentThread.ManagedThreadId}");
    ...
    public decimal[] CalculateStockastics()
    {
        ...
        Console.WriteLine($"Method name: {nameof(CalculateStockastics)}, Thread: {Thread.CurrentThread.ManagedThreadId}");

        Thread.Sleep(10000); // Represents the time it takes for the operations to complete
    ...
    public decimal[] CalculateFastMovingAverage()
    {
        ...
        Console.WriteLine($"Method name: {nameof(CalculateFastMovingAverage)}, Thread: {Thread.CurrentThread.ManagedThreadId}");

        Thread.Sleep(6000); // Represents the time it takes for the operations to complete
    ...
    public decimal[] CalculateSlowMovingAverage()
    {
        ...
        Console.WriteLine($"Method name: {nameof(CalculateSlowMovingAverage)}, Thread: {Thread.CurrentThread.ManagedThreadId}");

        Thread.Sleep(7000); // Represents the time it takes for the operations to complete
    ...
    public decimal[] CalculateUpperBoundBollingerBand()
    {
        ...
        Console.WriteLine($"Method name: {nameof(CalculateUpperBoundBollingerBand)}, Thread: {Thread.CurrentThread.ManagedThreadId}");

        Thread.Sleep(5000); // Represents the time it takes for the operations to complete
    ...
    public decimal[] CalculateLowerBoundBollingerBand()
    {
        ...
        Console.WriteLine($"Method name: {nameof(CalculateLowerBoundBollingerBand)}, Thread: {Thread.CurrentThread.ManagedThreadId}");
